...
public class SmartWatchList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			SmartWatch smarts = entry.getValue();
			if(i%3==1) pw.print("<tr>");
			pw.print("<td><div id='shop_item'>");
			pw.print("<h3>"+smarts.getName()+"</h3>");
			pw.print("<strong>$"+smarts.getPrice()+"</strong><ul>");
			pw.print("<li id='item'><img src='images/smart_watches_images/"+smarts.getImage()+"' alt='' /></li>");
